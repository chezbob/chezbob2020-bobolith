    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transacted_at', models.DateTimeField(verbose_name='transacted at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=4, default_currency='USD', max_digits=19, verbose_name='amount')),
                ('kind', models.CharField(choices=[('debit', 'Debit'), ('credit', 'Credit')], help_text='Is this transaction leg a debit or credit?', max_length=15, verbose_name='kind')),
                ('memo', models.TextField(blank=True, default='')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_legs', to='finances.Account')),
                ('transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='legs', to='finances.Transaction')),
            ],
        ),
    ]
